...
export const stories: Story[] = [
  {
    ...
    description: 'Un jeune héros découvre son héritage divin et doit naviguer dans un monde de dieux et de monstres pour sauver son peuple. Entre tradition et futurisme, les Orishas reprennent leur place dans le monde moderne.',
    genre: 'Mythologie africaine',
    genreSlug: 'mythologie-africaine',
    tags: ['Mythologie', 'Aventure', 'Magie', 'Epique'],
    views: 1200000,
    likes: 89000,
    subscriptions: 50000,
    chapters: [
        { id: '1-1', slug: 'chapitre-1-le-reveil', title: 'Le Réveil des Ancêtres', releaseDate: '2024-05-01', status: 'Publié', pageCount: 22, version: 'v1.2', revisionNote: 'Amélioration de la colorimétrie du panneau 4.' },
        { id: '1-2', slug: 'chapitre-2-l-epreuve', title: 'L\'Épreuve du Feu', releaseDate: '2024-05-15', status: 'Publié', pageCount: 25, version: 'v1.0' },
        { id: '1-3', slug: 'chapitre-3-l-ombre-grandit', title: 'L\'Ombre sur Lagos', releaseDate: '2024-06-01', status: 'Publié', pageCount: 23, version: 'v1.0' },
        { id: '1-4', slug: 'chapitre-4-la-trahison', title: 'Trahison Divine', releaseDate: '2024-06-15', status: 'Publié', pageCount: 24, version: 'v1.0' },
    ],
  ...
  },
  {
    ...
    description: 'Dans un Dakar futuriste, un détective amélioré cybernétiquement découvre une conspiration qui menace toute la ville. Une enquête haletante entre néons et traditions Wolof.',
    genre: 'Afrofuturisme',
    genreSlug: 'afrofuturisme',
    tags: ['Cyberpunk', 'Mystère', 'Action', 'Urbain'],
    views: 980000,
    likes: 75000,
    subscriptions: 42000,
    chapters: [
        ...
        { id: '2-2', slug: 'chapitre-2-le-contact', title: 'Le Contact Inattendu', releaseDate: '2024-05-10', status: 'Publié', pageCount: 28, version: 'v1.0' },
    ],
  ...
  },
  {
    ...
    description: 'Un voyage à travers le temps pour retrouver les histoires perdues d\'un grand royaume africain. Un hommage à la mémoire et à l\'héritage du continent.',
    genre: 'Histoire africaine',
    genreSlug: 'histoire-africaine',
    tags: ['Historique', 'Voyage dans le temps', 'Fantaisie', 'Culture'],
    views: 750000,
    likes: 62000,
    subscriptions: 35000,
    chapters: [
        { id: '3-1', slug: 'chapitre-1-la-relique', title: 'La Relique Oubliée', releaseDate: '2024-03-01', status: 'Publié', pageCount: 18, version: 'v1.0' },
        { id: '3-2', slug: 'chapitre-2-le-passage', title: 'Le Passage du Temps', releaseDate: '2024-03-15', status: 'Publié', pageCount: 20, version: 'v1.0' },
    ],
  ...
  },
  {
    ...
    description: 'Un récit court et intense sur les dernières minutes avant un saut spatial vers une nouvelle colonie. La survie de l\'humanité dépend d\'une seule décision.',
    genre: 'Science-Fiction',
    genreSlug: 'science-fiction',
    tags: ['One-shot', 'Espace', 'Drame', 'Suspense'],
    views: 120000,
    likes: 15000,
    subscriptions: 5000,
    chapters: [
  ...
  },
  {
    ...
    description: 'Un roman illustré explorant les légendes oubliées du Sahel à travers les yeux d\'une jeune érudite. Une quête de savoir et de vérité ancestrale.',
    genre: 'Contes revisités',
    genreSlug: 'contes-revisites',
    tags: ['Roman', 'Illustré', 'Légende', 'Sahel'],
    views: 85000,
    likes: 12000,
    subscriptions: 8000,
    chapters: [
        { id: '8-1', slug: 'partie-1-les-racines', title: 'Partie 1 : Les Racines du Savoir', releaseDate: '2024-07-01', status: 'Publié', pageCount: 60, version: 'v1.0' },
    ],
  ...
  },
  {
    ...
    description: 'Bientôt sur NexusHub : Une épopée mystique au cœur du royaume d\'Ifé. Quand les statues de bronze s\'animent pour protéger la cité.',
    genre: 'Fantaisie Historique',
    genreSlug: 'histoire-africaine',
    tags: ['Mystère', 'Art', 'Culture', 'Mythique'],
    views: 0,
    likes: 0,
    subscriptions: 1200,
    chapters: [],
...
export const comments: Comment[] = [
    {
        ...
        content: "Ce premier chapitre est incroyable ! Les designs des Orishas sont d'une finesse rare. On sent vraiment le travail de recherche sur les parures traditionnelles.",
    ...
    },
    {
        ...
        authorBadge: 'Top Fan',
        content: "Je parie que le protagoniste est en fait le fils caché de Shango. La révélation finale sera que son père n'est pas mort mais exilé dans le monde numérique. Regardez les indices dans les dialogues du début !",
    ...
    },
    {
        ...
        authorBadge: 'Artiste',
        content: "Merci pour vos retours ! Yannick, tu es sur une piste très intéressante... les chapitres 5 et 6 devraient confirmer certaines de tes intuitions.",
