        ...
        <div className="relative">
          ...
          <div className="p-8 space-y-8">
            ...
            <div className="space-y-3">
              <Button onClick={() => handleSocialLogin('Google')} disabled={!!isLoading} variant="outline" className="w-full h-12 rounded-xl border-white/10 bg-white/5 hover:bg-white/10 text-white font-bold gap-4 relative overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button onClick={() => handleSocialLogin('Facebook')} disabled={!!isLoading} variant="outline" className="h-12 rounded-xl border-white/10 bg-white/5 text-white font-bold gap-2">
                  {isLoading === 'Facebook' ? <Loader2 className="h-4 w-4 animate-spin" /> : 'Facebook'}
                </Button>
                <Button onClick={() => handleSocialLogin('Apple')} disabled={!!isLoading} variant="outline" className="h-12 rounded-xl border-white/10 bg-white/5 text-white font-bold gap-2">
                  {isLoading === 'Apple' ? <Loader2 className="h-4 w-4 animate-spin" /> : 'Apple'}
                </Button>
              </div>
            </div>
            ...
            <div className="pt-6 border-t border-white/5 text-center space-y-4">
              ...
              <div className="flex justify-center items-center gap-4 text-[8px] font-black uppercase tracking-widest text-stone-700">
                <div className="flex items-center gap-1"><ShieldCheck className="h-3 w-3" /> Sécurisé</div>
                <div className="h-1 w-1 rounded-full bg-stone-800" />
                <div className="flex items-center gap-1"><Sparkles className="h-3 w-3" /> Panafricain</div>
              </div>
            </div>
          </div>
        </div>
