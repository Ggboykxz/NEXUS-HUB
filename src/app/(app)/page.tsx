                    ...
                    {featuredStories.map((story, index) => {
                        ...
                        return (
                            <CarouselItem key={story.id}>
                                <div className="relative w-full aspect-[3/4] sm:aspect-[16/9] md:aspect-[2.4/1] min-h-[650px] sm:min-h-[450px] rounded-[1.5rem] md:rounded-[2rem] overflow-hidden group shadow-2xl border border-white/10 bg-stone-900">
                                    <Image
                                    ...
                                    />
                                    <div className="absolute inset-0 bg-gradient-to-t sm:bg-gradient-to-r from-black via-black/90 sm:via-black/60 to-transparent p-6 md:p-16 flex flex-col justify-end items-start text-left">
                                        <div className="carousel-content-animate flex flex-col gap-4 max-w-2xl w-full pb-12 sm:pb-0">
                                            ...
                                            <p className="text-white/90 text-sm md:text-lg font-light leading-relaxed line-clamp-3 sm:line-clamp-4 mb-4 italic border-l-2 border-primary/50 pl-4 md:pl-6 max-w-xl">
                                                "{story.description}"
                                            </p>
