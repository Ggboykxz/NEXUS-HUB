                                        ...
                                        <div className="flex flex-col gap-2 max-w-2xl w-full">
                                            ...
                                            <Link href={`/artiste/${artist?.slug}`} className="flex items-center gap-2 mt-1 group/artist-info w-fit">
                                                <div className="relative">
                                                    ...
                                                    {artist?.isMentor && <div className="absolute -top-1 -right-1 bg-emerald-500 rounded-full p-0.5 border border-background shadow-lg"><Award className="h-2 w-2 text-white" /></div>}
                                                </div>
