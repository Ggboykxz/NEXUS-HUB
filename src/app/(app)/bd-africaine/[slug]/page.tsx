...
import { stories, artists, comments as allComments, type Story, type Artist, type Chapter, getChapterUrl } from '@/lib/data';
...
export default function BdDetailPage(props: { params: Promise<{ slug: string }> }) {
